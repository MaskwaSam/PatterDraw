...
This directory is reserved for the future GPL-3.0-or-later `mod_patterdraw` activity. It must be a new Moodle module, not an editor switch inside `mod_polypad`.
