...
export function createDualScaleRulerAsset(): DualScaleRulerAsset {
  const svg = [
    ...
    `<g fill="#27200e" font-family="Arial, Helvetica, sans-serif" font-size="8" font-weight="600">`,
    labels(RULER_LENGTH_CENTIMETRES, PDF_POINTS_PER_CENTIMETRE, 34, "cm"),
    labels(RULER_LENGTH_INCHES, PDF_POINTS_PER_INCH, 64, "in"),
    `</g>`,
    `<g fill="#5f4a0f" font-family="Arial, Helvetica, sans-serif" font-size="8" font-weight="700" letter-spacing="0.6">`,
    `<text x="${RULER_WIDTH_POINTS / 2}" y="42" text-anchor="middle">CENTIMETRES</text>`,
    `<text x="${RULER_WIDTH_POINTS / 2}" y="55" text-anchor="middle">INCHES</text>`,
    `</g>`,
    `</svg>`,
  ].join("");
  return {
